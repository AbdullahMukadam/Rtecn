...
description: Custom link extension for @rtecn/editor with keyboard shortcut.
package: "@rtecn/editor"
---

# Link Extension

`@rtecn/editor` ships a custom `Link` extension that extends `@tiptap/extension-link`.
