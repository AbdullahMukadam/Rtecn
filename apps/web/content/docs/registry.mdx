...
Rtecn packages are available as a [shadcn registry](https://ui.shadcn.com/docs/registry), allowing you to install the source code directly into your project using the shadcn CLI. **This is the recommended way to install rtecn packages** — it copies the editor source straight into your project so you have full control over styling and behavior, rather than depending on a published `node_modules` package.
