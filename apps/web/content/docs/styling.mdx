...
Both editors support `data-variant` attribute on the root element. Use it to target specific variants:
...
/* Target minimal variant (block editor) */
[data-variant="minimal"] .block-editor-content .ProseMirror {
