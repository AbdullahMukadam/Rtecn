...
const nodeItems: NodeItem[] = [
  {
    ...
    isActive: (s) => s.isParagraph && !s.isBulletList && !s.isOrderedList && !s.isTaskList && !s.isBlockquote && !s.isCodeBlock,
  },
  {
    name: "Heading 1",
...
function useEditorState(editor: Editor, selector: (e: Editor) => SelectorResult): SelectorResult {
          ...
          <div className="block-editor-bubble-dropdown">
            {nodeItems.map((item, i) => (
              <button
                ...
                onClick={() => { item.command(editor); setOpen(false); }}
              >
                <span>{item.name}</span>
            ...
            <button
              ...
              onClick={() => { duplicateBlock(editor); setOpen(false); }}
            >
              <DuplicateIcon />
              <span>Duplicate</span>
            </button>
            <button
              ...
              onClick={() => { deleteBlock(editor); setOpen(false); }}
            >
              <DeleteIcon />
              <span>Delete</span>
            </button>
...
function useTextEditorState(editor: Editor, selector: (e: Editor) => TextSelectorResult): TextSelectorResult {
  const [state, setState] = useState<TextSelectorResult>(() => selector(editor));
  useState(() => {
    const update = () => setState(selector(editor));
    editor.on("selectionUpdate", update);
    editor.on("transaction", update);
...
function useAlignEditorState(editor: Editor, selector: (e: Editor) => AlignSelectorResult): AlignSelectorResult {
  const [state, setState] = useState<AlignSelectorResult>(() => selector(editor));
  useState(() => {
    const update = () => setState(selector(editor));
    editor.on("selectionUpdate", update);
    editor.on("transaction", update);
...
function TextAlignSelector({ editor }: { editor: Editor }) {
  ...
  const editorState = useAlignEditorState(editor, (ed) => ({
    isAlignLeft: !ed.isActive({ textAlign: "center" } as any) && !ed.isActive({ textAlign: "right" } as any),
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      {open && (
        <>
          <div className="block-editor-bubble-overlay" onClick={() => setOpen(false)} />
          <div className="block-editor-bubble-dropdown block-editor-bubble-dropdown--align" style={{ right: 0, left: "auto" }}>
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      {open && (
        <>
          <div className="block-editor-bubble-overlay" onClick={() => setOpen(false)} />
          <div className="block-editor-bubble-dropdown" style={{ right: 0, left: "auto", minWidth: "220px" }}>
...
/* SVG icons */
function BoldIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" /><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z" /></svg>; }
function ItalicIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="19" x2="10" y1="4" y2="4" /><line x1="14" x2="5" y1="20" y2="20" /><line x1="15" x2="9" y1="4" y2="20" /></svg>; }
function UnderlineIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 4v6a6 6 0 0 0 12 0V4" /><line x1="4" x2="20" y1="20" y2="20" /></svg>; }
function StrikethroughIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16 4H9a3 3 0 0 0-2.83 4" /><path d="M14 12a4 4 0 0 1 0 8H6" /><line x1="4" x2="20" y1="12" y2="12" /></svg>; }
function CodeIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg>; }
function AlignLeftIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="21" x2="3" y1="6" y2="6" /><line x1="15" x2="3" y1="12" y2="12" /><line x1="17" x2="3" y1="18" y2="18" /></svg>; }
function AlignCenterIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="21" x2="3" y1="6" y2="6" /><line x1="17" x2="7" y1="12" y2="12" /><line x1="19" x2="5" y1="18" y2="18" /></svg>; }
function AlignRightIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="21" x2="3" y1="6" y2="6" /><line x1="21" x2="9" y1="12" y2="12" /><line x1="21" x2="7" y1="18" y2="18" /></svg>; }
function DropdownArrowIcon() { return <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m6 9 6 6 6-6" /></svg>; }
...
function DuplicateIcon() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg>; }
function DeleteIcon() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>; }
function LinkIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>; }
function UnlinkIcon() { return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="2" x2="22" y1="2" y2="22" /><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>; }
